  ...
  return (
    <>
      ...
      <div className='w-full flex'>
        ...
        >
          Voici les différents projets sur lesquels j'ai pu travaillé actuellement
          afin de m'exercer. Chaque projet comporte une brève description ainsi qu'un lien vers le site en ligne et son repo github.
        </motion.p>
      </div>
